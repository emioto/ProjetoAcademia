...
return [
   ...
   'ruleNotFound'          => 'Regra {0} não foi encontrada.',
   'groupNotFound'         => 'Grupo de regras {0} não foi encontrado.',
   'groupNotArray'         => 'Grupo de regras {0} deve ser um array.',
   ...
   'required_with'         => 'O campo \'{field}\' é obrigatório quando o campo {param} está preenchido.',
   'required_without'      => 'O campo \'{field}\' é obrigatório quando o campo {param} não está preenchido.',
